...
d'utilisateurs actifs. Chaque jour, des milliers d'artistes publient de 
nouveaux titres sur la plateforme, mais la grande majorité passe 
complètement inaperçue. Une question se pose alors naturellement : 
qu'est-ce qui fait vraiment qu'une chanson devient populaire ?

C'est exactement la question que nous avons décidé d'explorer dans ce 
projet. En analysant le Spotify Tracks Dataset — un jeu de données 
contenant 114 000 chansons issues de 114 genres musicaux différents — 
nous cherchons à comprendre si les caractéristiques audio mesurables 
d'une chanson (son énergie, sa dansabilité, son tempo, son volume...) 
permettent de prédire sa popularité. Un enjeu très concret pour les 
artistes indépendants, les labels musicaux et les plateformes de 
streaming qui cherchent à mieux comprendre ce qui résonne avec leur 
audience.
